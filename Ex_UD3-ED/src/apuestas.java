...
/**
 * 
 * @param evt eliminacion del evento
 */
...
/**
 * 
 * @param evt reseteo de la apuestas
 */
   ...
   /**
    * 
    * @param n1 realiza una primera apuesta
    * @param n2 realiza una segunda apuesta
    * @return 
    */
    ...
    /**
     * 
     * @param evt realiza apuestas del evento
     */
...
/**
 * 
 * @param partido partidos nuevos a jugar
 */
  ...
  /**
   * 
   * @param indice borrar partidos viejos
   */
   ...
   /**
    * 
    * @param args agregacion del evento
    */
